...
from data.data_loader import data_detime, split_data
import torch
...
class Exp_Deterministic_Forecast(Exp_Basic):
    def __init__(self, args):
        super(Exp_Deterministic_Forecast, self).__init__(args)
    ...
    def run(self):
        ...
        with open(f'data_record/{self.args.site}/{self.args.dataset}/Metrics_{model_name}.csv', 'a', encoding='utf-8',
                  newline='') as f:
