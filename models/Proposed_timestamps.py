...
class Proposed(nn.Module):
    def __init__(self, seq_len,pred_len,patch_len,e_layers,enc_in,d_model,n_heads,embed_size,hidden_size,dim_f=None):
        super(Proposed, self).__init__()
        self.frets = Frets(embed_size = embed_size, hidden_size = hidden_size,pred_len=pred_len,enc_in=1,seq_len=seq_len)
        self.timexer = Timexer(seq_len=seq_len,patch_len=patch_len,pred_len=pred_len,d_model=d_model,e_layers=e_layers,enc_in=enc_in,n_heads=n_heads)
