...
class TimeXer(nn.Module):
    ...
    def __init__(self, seq_len, pred_len, patch_len, e_layers, enc_in, d_model, n_heads, drop=0.1, use_norm=False,prob=False):
        ...
        if not self.prob:
            self.head = FlattenHead(self.enc_in, self.head_nf, self.pred_len,head_dropout=self.drop)
        else:
            self.head = FlattenHead(self.enc_in, self.head_nf, self.pred_len*7,head_dropout=self.drop)
