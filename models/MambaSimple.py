...
class Mamba_simple(nn.Module):
    ...
    def __init__(self, pred_len,d_model,d_conv,d_ff,expand,enc_in,e_layers,c_out):
        super(Mamba_simple, self).__init__()
...
class MambaBlock(nn.Module):
    ...
    def selective_scan(self, u, delta, A, B, C, D):
        ...
        # From a discussion with authors: "A is the more important term and the performance
        # doesn't change much with the simplification on B"
